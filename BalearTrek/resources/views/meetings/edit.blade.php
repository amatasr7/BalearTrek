<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar Publicación') }} : {{ $meeting->trek->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form action="{{ route('meetings.update', $meeting->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1 text-gray-400">Excursió (No editable)</label>
                    ...
                    <div class="mb-4">
                        <label for="user_id" class="block text-sm font-medium text-gray-700 mb-1">Guia Assignat</label>
                        <select name="user_id" id="user_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="">Sense guia</option>
                    ...
                    <div class="mb-6">
                        <label for="publicat" class="block text-sm font-medium text-gray-700 mb-1">Publicat</label>
                        <select name="publicat" id="publicat" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="1" {{ $meeting->publicat ? 'selected' : '' }}>Si</option>
